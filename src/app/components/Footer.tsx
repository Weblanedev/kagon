        ...
        <section className='contact-us h-[100%] py-[134px]' id="Contact">
            ...
            <div className='container mx-auto px-[20px] sm:px-[60px] font-body flex flex-col lg:flex-row gap-[40px] pt-[20px]'>
                <div className='w-[100%] hidden sm:block'>
                    <h1 className='text-[20px] leading-normal pt-[20px] text-[#242B6B] w-[280px] uppercase text-3xl font-[600] text-left'>kagon Technologies Limited</h1>
                </div>
                <div className='flex flex-col gap-[20px] text-[20px] w-[100%]'>
                    <h1 className='text-[#242B6B] leading-normal'>Home</h1>
                ...
                <div className='flex flex-col gap-[20px] text-[20px] w-[100%]'>
                    <h1 className='text-[#242B6B] leading-normal'>Product</h1>
                    <div className='text-white flex flex-col gap-[20px]'>
                ...
                <div className='w-[100%] lg:text-right text-[20px]'>
                    <div>
                        <h1 className='text-[#242B6B] leading-normal'>Address 1</h1>
                        <p className='text-white'>OZOEBUBECHUKWU COMPOUND, AGBANA VILLAGE, AWKA-SOUTH</p>
                    </div>
                    <div className='py-[20px]'>
                        <h1 className='text-[#242B6B] leading-normal'>Operating Address</h1>
                        <p className='text-white'>6 ONITANA STREET, OFF MOBOLAJI JOHNSON, IKOYI, LAGOS</p>
                    </div>
                    <div>
                        <h1 className='text-[#242B6B] leading-normal'>Email</h1>
                ...
                <div className='w-[100%] block sm:hidden'>
                    ...
                    <h1 className='text-[20px] leading-normal pt-[20px] text-white w-[280px]'>kagon Technologies Limited AND ALLIED INTEGRATED LIMITED</h1>
                </div>
            </div>
            <div className='container mx-auto px-[20px] sm:px-[60px] font-body flex flex-col lg:flex-row gap-[40px] pt-[20px]'>
